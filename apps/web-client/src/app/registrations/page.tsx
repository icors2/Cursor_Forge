  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-10">
      ...
      <p className="mb-6 text-sm text-emerald-100/60">
        {staff
          ? "Open a window so parents and players can apply. Promote the pool onto the roster."
      ...
      {staff ? (
        <form onSubmit={handleOpen} className="mb-8 space-y-3 rounded-2xl border border-emerald-900 bg-court-900/80 p-5">
